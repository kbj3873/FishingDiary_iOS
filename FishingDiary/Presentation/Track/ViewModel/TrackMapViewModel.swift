...
protocol TrackMapViewModelInput {
    func viewDidLoad()
    func viewWillDisappear()
}

protocol TrackMapViewModelOutput {
...
typealias TrackMapViewModelProtocol = TrackMapViewModelInput & TrackMapViewModelOutput
...
extension TrackMapViewModel: TrackMapViewModelProtocol {
    func viewDidLoad() {
