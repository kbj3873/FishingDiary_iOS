...
install_xcframework "${PODS_ROOT}/Realm/core/realm-monorepo.xcframework" "realm-monorepo" "library" "ios-arm64" "ios-arm64_x86_64-simulator" "ios-arm64_x86_64-maccatalyst"
